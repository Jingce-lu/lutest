...
你可能用过 [jsfiddle](https://jsfiddle.net) 或 [jsbin](https://jsbin.com/?html,output) 之类的网站，在里面你可以用 CDN 的形式引入 Vue.js，然后在线写示例，实时运行，比如下面这个例子：

[jsfiddle.net/c87yh92v/](https://jsfiddle.net/c87yh92v/)
