...
![](https://user-gold-cdn.xitu.io/2018/11/15/16716c44a664e7f1?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)

因为结构简单，我们甚至不需要组件，直接使用标准的 table 系列标签就可以。但有的时候，除了呈现数据，也会带有一些交互，比如有一列操作栏，可以编辑整行的数据：
![](https://user-gold-cdn.xitu.io/2018/11/15/16716c54fc74a1a5?imageslim)
...
```
运行后的效果如下图：
![](https://user-gold-cdn.xitu.io/2018/11/15/16716c5b99ef76ac?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
```
效果如下图：
![](https://user-gold-cdn.xitu.io/2018/11/15/16716c604e151fa0?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
```
>完整的代码见：[github.com/icarusion/v…](https://github.com/icarusion/vue-component-book/blob/master/src/views/table-render.vue)
