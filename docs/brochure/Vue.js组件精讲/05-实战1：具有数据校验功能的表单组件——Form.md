...
（也可以在线访问本示例体验：[run.iviewui.com/jwrqnFss](https://run.iviewui.com/jwrqnFss)）
![](https://img1.yixinfinance.com/wiki/images/166c3b75c37ef9a8)
...
>本节所有代码可以在 [github.com/icarusion/v…](https://github.com/icarusion/vue-component-book) 中查看，你可以一边看源码，一边阅读本节；也可以边阅读，边动手实现一遍，遇到问题再参考完整的源码。
...
![](https://img1.yixinfinance.com/wiki/images/166c3b7f124cb84a)
...
```
运行效果：
![](https://img1.yixinfinance.com/wiki/images/166c3b8a77e382ec)

完整的示例源码可通过 GitHub 查看：

[github.com/icarusion/v…](https://github.com/icarusion/vue-component-book)
